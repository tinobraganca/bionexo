...
//    }
    ...
    public void createTB_UBS() throws Exception {
        ...
        restTB_UBSMockMvc.perform(post("/api/tb-ubs")
    ...
    public void getAllTB_UBS() throws Exception {
        ...
        restTB_UBSMockMvc.perform(get("/api/tb-ubs?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].no_estrutra_fisica_ambiencia").value(hasItem(DEFAULT_NO_ESTRUTRA_FISICA_AMBIENCIA.toString())))
            .andExpect(jsonPath("$.[*].no_adap_defic_fisic_idoso").value(hasItem(DEFAULT_NO_ADAP_DEFIC_FISIC_IDOSO.toString())))
    ...
    public void getTB_UBS() throws Exception {
        ...
        // Get the tB_UBS
        restTB_UBSMockMvc.perform(get("/api/tb-ubs/{id}", tB_UBS.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
            ...
            .andExpect(jsonPath("$.no_estrutra_fisica_ambiencia").value(DEFAULT_NO_ESTRUTRA_FISICA_AMBIENCIA.toString()))
    ...
    public void getNonExistingTB_UBS() throws Exception {
        // Get the tB_UBS
        restTB_UBSMockMvc.perform(get("/api/tb-ubs/{id}", Long.MAX_VALUE))
...
//    }
    ...
    public void deleteTB_UBS() throws Exception {
        ...
        // Get the tB_UBS
        restTB_UBSMockMvc.perform(delete("/api/tb-ubs/{id}", tB_UBS.getId())
